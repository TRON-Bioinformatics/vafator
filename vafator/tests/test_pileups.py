...
class TestPileups(TestCase):
    ...
    def test_insertion_metrics(self):
        ...
        self._assert_metrics(variant=variant, expected_ac={'TGG': 0}, expected_dp=2)
        ...
        self._assert_metrics(variant=variant, expected_ac={'TGGG': 1}, expected_dp=2)
        ...
        self._assert_metrics(variant=variant, expected_ac={'TGGA': 0}, expected_dp=2)
        ...
        self._assert_metrics(variant=variant, expected_ac={'TGGGG': 1}, expected_dp=2)
        ...
        self._assert_metrics(variant=variant, expected_ac={'TGGGGG': 0}, expected_dp=2)

    def test_insertion_metrics_2(self):
        variant = VafatorVariant(chromosome="chr1", position=1594199, reference="C", alternative=["CT"])
        self._assert_metrics(variant=variant, expected_ac={'CT': 9}, expected_dp=9)
        self._assert_metrics(variant=variant, expected_ac={'CT': 5}, expected_dp=5, min_mapping_quality=40)
    ...
    def test_deletion_metrics(self):
        ...
        self._assert_metrics(variant=variant, expected_ac={'G': 12}, expected_dp=12)
